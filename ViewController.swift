...
class ViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    view.backgroundColor = .newPrimaryColor


      buttonSave.addTarget(self, action: #selector(onTapSave), for: .touchUpInside)
  ...
  @IBAction func onTapPhotoLibrary(_ sender: Any) {
    ...
    @IBAction func onTapSave(_ sender: Any) {
        ...
        let bottomImage = inputImageView.image
        let topImage = resultImageView.image

        let size = CGSize(width: inputImageView.image!.size.width, height: inputImageView.image!.size.height)
